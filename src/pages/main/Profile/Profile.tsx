...
import {ExperimentOutlined,  MedicineBoxOutlined, TeamOutlined, UserOutlined} from "@ant-design/icons";
    ...
    return (
        <Row>
            <Col className={"Column"} >
                <Tabs  tabPosition={'left'} defaultActiveKey="1" style={{padding:10}} items={items}/>
            </Col>
        </Row>
    )
}

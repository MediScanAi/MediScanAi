...
const menuItems: MenuProps['items'] = [
    ...
    {
        label:  (<span><ExperimentOutlined/>  Analysis</span>) ,
        key: 'analysis',
        children: [
            {
                label: 'Blood Test',
    ...
    {
        label:(<span><MedicineBoxOutlined/>  Your AI Doctor</span>) ,
        key: 'ai-doctor',
    },
    {
        label: (<span><TeamOutlined/>  About Us</span>),
        key: 'about-us',
    },
];
...
const burgerItems: MenuProps['items'] = [
    ...
    {
      label: (<Dropdown trigger={['hover']} menu={{items:analysisItems}} ><div style={{height:'100%',width:'100%'}}><ExperimentOutlined/>  Analysis</div></Dropdown>),
        key: 'analysis',
    },
    {
...
function Header() {
    ...
    const activeKey = useLocation().pathname === '/' ? 'home' : useLocation().pathname.substring(1);

        ...
        <header>
            ...
            >
                ...
                <div className={'Right-buttons'}>
                    {user ?
                        <Dropdown trigger={['click']} menu={{items: userItems}} onOpenChange={toggleArrow}>
                            <div
                        ...
                        <Button onClick={() => navigate('/auth/login')} ghost variant={"text"}
                    ...
                    <Select onChange={(value) => {
                        ...
                        localStorage.setItem('language', value);
                            ...
                            defaultValue={i18n.language} variant={'borderless'} options={options}
                            optionRender={(option) => {
                                return (
                                    <Space>
                                        {option.data.label}

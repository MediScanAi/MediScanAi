      ...
      <div className="footer-container">
        <Row gutter={[32, 32]} style={{ width: '100%' }}>
          <Col xs={24} md={12} lg={8}>
            <img src={theme ? logoDark : logoLight} alt="MediScan AI Logo" className="footer-logo" />
          ...
          <Col xs={24} md={12} lg={8}>
            <Title level={5} className="footer-heading">{t('footer.company')}</Title>
          ...
          <Col xs={24} md={12} lg={8}>
            <Title level={5} className="footer-heading">{t('footer.contactUs')}</Title>
            <div className="footer-contact">
              <p><EnvironmentOutlined /> {t('footer.location')}</p>
              <p><PhoneOutlined /> {t('footer.phone')}</p>
              <p><MailOutlined /> contact@mediscan.ai</p>
              <p><ClockCircleOutlined /> {t('footer.workingHours')}</p>
            </div>
          </Col>
        </Row>
        ...
        <div className="footer-bottom">
          <Text className='footer-copyright'>
            © {new Date().getFullYear()} MediScan AI. {t('footer.allRightsReserved')} |
            <Link href="/about-us" style={{ marginLeft: '10px' }}>{t('footer.privacyPolicy')}</Link> |
            <Link href="/about-us" style={{ marginLeft: '10px' }}>{t('footer.termsOfService')}</Link> |
          </Text>
        </div>
      </div>
    </footer>
